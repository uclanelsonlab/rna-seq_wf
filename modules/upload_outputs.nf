process upload_files {
    ...
    aws s3 cp ${all_rare_junctions} s3://ucla-rare-diseases/UCLA-UDN/rnaseq/output/rare_junctions/${library}/
    aws s3 cp ${rare_junctions} s3://ucla-rare-diseases/UCLA-UDN/rnaseq/output/rare_junctions/${library}/${all_rare_junctions}
